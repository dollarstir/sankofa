                    ...
                    <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing"   style="margin: auto;">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">                                
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                       <center> <u><h4>Add Teacher</h4></u></center>
                                    </div>                                                      
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <form class="       ">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input name="tname" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Full Name">
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="tcontact" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder=" Phone Number">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="temail" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Email address">
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="hometown" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Home town">
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input name="tdob" type="Date" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Date of Birth">
                                    </div>
                                    <!-- <style>
                                        .disp {
                                            display: none;
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <select name="tgender" class="form-control-rounded form-control" id="exampleFormControlSelect1">
                                    ...
                                    <div class="form-group mb-4">
                                      ...
                                      <select name="mstatus" class="form-control-rounded form-control" id="exampleFormControlSelect1">
                                  ...
                                  <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Date of birth</label> -->
                                        <input name="qualification" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Qualification">
                                    </div>

                                    <div class="form-group mb-4">
                                        <label for="exampleFormControlInput1">Date Appointed</label>
                                        <input name="dateadded" type="Date" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Date of Approval">
                                    </div>
                                    
                                   
                                    <input type="submit" name="sub" class="mt-4 mb-4 btn btn-button-7 btn-rounded sub" value="Add Teacher" style="margin-left:150px;background-color:green !important;">
