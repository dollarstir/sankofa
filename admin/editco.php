                            ...
                            <div class="widget-header">                                
                                <div class="row">
                                        ...
                                        <?php  
                                            ...
                                            $getpro=mysqli_query($conn,"SELECT * FROM programme WHERE id = '$id' ");
                                            $rap = mysqli_fetch_array($getpro);
                                            $ctitle = $rap['ctitle'];
                                            $duration = $rap['duration'];
                                            $arequirement = $rap['arequirement'];
                                            $location = $rap['location'];
                                            $level= $rap['level'];
                                            $structure = $rap['structure'];
                                        ...
                                        ?>
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                       <center> <u><h4>Edit Course</h4></u></center>
                                    </div>                                                      
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <form class="editbcourse">
                                   
                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="ctitle" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Course Title" value= "<?php echo $ctitle ;?>" >
                                    </div>

                                    <input name="edid" type="hidden" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Course Title" value= "<?php echo $id; ?>" >



                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="duration" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Duration. eg: (6 months) or (1 year)"  value= "<?php echo $duration ;?>">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="arequirement" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Admission requirement" value= "<?php echo $arequirement; ?>">
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="location" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Location/Mode . eg : Online, Main Campus(offline)  " value= "<?php echo $location; ?>">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="fees" type="number" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Fees for this course  "  value= "<?php echo $fees ;?>">
                                    </div>
                                  ...
                                  <div class="form-group mb-4">
                                    ...
                                    <input type="submit" name="editbtn" class="mt-4 mb-4 btn btn-button-7 btn-rounded sub" value="Update Course" style="margin-left:150px;background-color:green !important;">
