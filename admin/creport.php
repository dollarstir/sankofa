                    ...
                    <div class="col-lg-12 layout-spacing" style="margin-top:-40px;">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <center><h4>Get Sales Report</h4><center>
                                    </div>                                                                        
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <form class="form-inline justify-content-center mb-4" method="POST" action="creport.php">


                                
                                      
                                      <select name="customer" class="form-control-rounded form-control" id="exampleFormControlSelect1">
                                          <option value="">Choose customer</option>
                                          <?php 
                                                include "db.php";
                                                $getcat= mysqli_query($conn,"SELECT* FROM customers");
                            ...
                            <div class="widget-content widget-content-area">
                                <div class="table-responsive mb-4">
                                    <table id="html5-extension" class="table table-striped table-bordered table-hover" style="width:100%">
                                        ...
                                        ';
                                        include "db.php";
                                            $vp =mysqli_query($conn,"SELECT * FROM sales WHERE date_added >= '$fro' AND date_added <= '$to'");
                                        
                                            while ($vip= mysqli_fetch_array($vp)) {
               
                                                $id = $vip['id'];
                                                $product= $vip['product_name'];
                                                ...
                                                $query_sr = mysqli_query($conn, "SELECT * FROM sales_report WHERE id = '$srid'");
                                                $salesreportDetails= mysqli_fetch_array($query_sr);
                                                
                                                $customer = $salesreportDetails['Cname'];
                                                $reportInvoice = $salesreportDetails['invoice'];
                                                $salesrid = $salesreportDetails['id'];

                                                if($customer == $customerID) {

                                                    $query_pro = mysqli_query($conn, "SELECT * FROM drugs WHERE id = '$product'");
                                                    $productdetails = mysqli_fetch_array($query_pro);
                                                    ...
                                                    $query_cat = mysqli_query($conn, "SELECT * FROM category WHERE id = '$category'");
                                                    $categorydetails = mysqli_fetch_array($query_cat);
    
                                                    $category = $categorydetails['name'];
    

                                                    $query_customer = mysqli_query($conn, "SELECT * FROM customers WHERE id = '$customer'");
                                                    $customerdetails = mysqli_fetch_array($query_customer);
                                                    ...
                                                    <td><a href="invoice-print.php?target='.$salesrid.'" <span class="flaticon-print"></span></a></td>
                                ...
                                <div class="widget-content widget-content-area">
                                    <div class="table-responsive mb-4">
                                        <table id="html5-extension" class="table table-striped table-bordered table-hover" style="width:100%">
                                            ...
                                            ';
                                            include "db.php";
                                            $vp =mysqli_query($conn,"SELECT * FROM sales");
