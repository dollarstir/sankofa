                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                    ...
                                    <?php
                                        include 'db.php';
                                        $id = $_GET['pid'];
                                        $getpro= mysqli_query($conn,"SELECT * FROM drugs WHERE id= '$id' ");
                                ...
                                <form class="upprod">
                                  ...
                                  <label for="exampleFormControlInput1">Category</label>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input name="remaining" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Quantity remaining" value="<?php echo $remaining ;?>">
                                    </div>
