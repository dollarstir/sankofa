                    ...
                    <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing"   style="margin: auto;">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">                                
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                       <center> <u><h4>Add Purchases</h4></u></center>
                                    </div>                                                      
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <form class="adpurch">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input name="bname" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Brand Name">
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="gname" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Genetic Name">
                                    </div>
                                  ...
                                  <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="quantity" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Quantity">
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input name="expire" type="date" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Expiration Date">
                                    </div>
                                    ...
                                    <input type="submit" name="subc" class="mt-4 mb-4 btn btn-button-7 btn-rounded sub" value="Add Purchase" style="margin-left:150px;background-color:green !important;">
