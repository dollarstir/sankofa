                    ...
                    <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing"   style="margin: auto;">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">                                
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                       <center> <u><h4>Edit customer</h4></u></center>
                                    </div>                                                      
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                            ...
                            <?php
                                        include 'db.php';
                                        $id = $_GET['pid'];
                                        $getpro= mysqli_query($conn,"SELECT * FROM customers WHERE id= '$id' ");
                                ...
                                <form class="edicos">
                                    ...
                                    <input type="submit" name="subc" class="mt-4 mb-4 btn btn-button-7 btn-rounded sub" value="Update Customer" style="margin-left:150px;background-color:green !important;">
