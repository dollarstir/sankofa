                            ...
                            <div class="widget-header">                                
                                <div class="row">
                                        ...
                                        <?php  
                                            ...
                                            $getpro=mysqli_query($conn,"SELECT * FROM applicant WHERE id = '$id' ");
                                            $rap = mysqli_fetch_array($getpro);
                                            $fname=$rap['fname'];
                                            $lname=$rap['lname'];
                                            $name = $rap['fname'].' '.$rap['lname'];
                                            $email=$rap['email'];
                                            $contact=$rap['contact'];
                                            $dob=$rap['dob'];
                                            $gender=$rap['gender'];
                                            ...
                                            $start=$rap['start'];
                                            $end=$rap['end'];
                                            $programe=$rap['programe'];
                                            $pname=$rap['pname'];
                                            $native=$rap['native'];
                                            $pcontact=$rap['pcontact'];
                                        ...
                                        ?>
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                       <center> <u><h4>View Applicant</h4></u></center>
                                       <br><br>

                                     <center>   <img src="../<?php echo $pic;?>" alt="" style="width:100px;height:100px;border-radius:10px;"></center>
                                    </div>                                                      
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <form class="subcourse">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input name="name" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Name" value= "<?php echo $name ?>" >
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="email" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="email"  value= "<?php echo $email ?>">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="contact" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="contact" value= "<?php echo $contact ?>">
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="dob" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="dob  " value= "<?php echo $dob ?>">
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                      ...
                                      <select name="gender" class="form-control-rounded form-control" id="exampleFormControlSelect1">
                                    ...
                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="town" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="town  "  value= "<?php echo $town ?>">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="nation" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Natinality  "  value= "<?php echo $nation ?>">
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                      ...
                                      <select name="sex" class="form-control-rounded form-control" id="exampleFormControlSelect1">
                                  ...
                                  <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="pob" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Place of birth  "  value= "<?php echo $pob ?>">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="position" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Occupation  "  value= "<?php echo $position ?>">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="rel" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Religion  "  value= "<?php echo $rel ?>">
                                    </div>
                                    

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="s1" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="First Institution  "  value= "<?php echo $s1 ?>">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="c1" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Certificate  "  value= "<?php echo $c1 ?>">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="start" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="from  "  value= "<?php echo $start ?>">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="end" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="end  "  value= "<?php echo $end ?>">
                                    ...
                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="programe" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Programme  "  value= "<?php echo $programe ?>">
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="pname" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="parent name  "  value= "<?php echo $pname ?>">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="native" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="native  "  value= "<?php echo $native ?>">
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="pcontact" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Parent contact  "  value= "<?php echo $pcontact ?>">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="doa" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Date Applied  "  value= "<?php echo $doa ?>">
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="status" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Admission status  "  value= "<?php echo $status ?>">
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="yoa" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="yoa  "  value= "<?php echo $yoa ?>">
                                    </div>
                                  ...
                                  <!-- <div class="form-group mb-4">
                                        <label for="exampleFormControlTextarea1"> Course Structure Below</label>
                                        <textarea name="structure" class="form-control-rounded form-control" id="exampleFormControlTextarea1" rows="3"><?php echo $structure; ?></textarea>
                                    </div>


                                    <div class="form-group mb-4">
                                        <label for="exampleFormControlTextarea1">Enter Course Description Below</label>
                                        <textarea name="description" class="form-control-rounded form-control" id="exampleFormControlTextarea1" rows="3"><?php echo $description ; ?></textarea>
                                    </div> -->

                                    
                                   
                                    <!-- <input type="submit" name="subc" class="mt-4 mb-4 btn btn-button-7 btn-rounded sub" value="Add Course" style="margin-left:150px;background-color:green !important;"> -->
